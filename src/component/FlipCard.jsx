export default function FlipCard({ image, github, demo, title }) {
  return (
    <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-96 mx-auto">
      {/* ✅ Desktop (flip) */}
      <div className="hidden sm:block flip-card w-full h-60">
      ...
      {/* ✅ Mobile (no flip, stacked view) */}
      <div className="sm:hidden bg-[#181e41] border border-[#2a2a40] rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="p-3 text-center">
          ...
          <div className="flex justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 py-1 bg-white text-[#181e41] text-sm font-semibold rounded-lg shadow-md hover:bg-gray-200"
            >
              🔗 GitHub
            </a>
            <a
